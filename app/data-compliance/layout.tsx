      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-gray-950/90 backdrop-blur-xl">
        <div className="max-w-5xl mx-auto px-5 flex items-center justify-between h-14">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center text-xs shadow-lg shadow-pink-500/20">🌸</div>
            <span className="text-sm font-bold tracking-tight text-white">FlowerGoUa</span>
          </Link>
          <Link href="/" className="text-xs text-gray-500 hover:text-white transition-colors">← Головна</Link>
        </div>
      </header>
          ...
          <div className="lg:sticky lg:top-24">
            ...
            <div className="mt-8 pt-6 border-t border-white/[0.06] px-1">
              <p className="text-[10px] text-gray-700 leading-relaxed">
                ...
                <a href="mailto:legal@flowergoua.com" className="text-gray-500 hover:text-white transition-colors underline">legal@flowergoua.com</a>
              </p>
            </div>
          </div>
        </aside>
