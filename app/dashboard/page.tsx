  ...
  return (
    <div className="p-4 md:p-6 xl:p-8 max-w-7xl mx-auto overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">Вітаємо 👋</h1>
        ...
        <div className="flex items-center gap-2">
          <Link href={`/${shopSlug}`} target="_blank"
            className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-600 hover:text-pink-600 bg-white border border-gray-200 hover:border-pink-200 px-3 py-2 rounded-xl transition-all shadow-sm">
          ...
          <Link href="/dashboard/assortment"
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-white bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 px-3 py-2 rounded-xl transition-all shadow-sm">
            + Додати букет
          </Link>
        </div>
      </div>
