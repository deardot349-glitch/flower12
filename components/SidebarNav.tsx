...
export default function SidebarNav({ shopSlug }: { shopSlug?: string | null }) {
  ...
  return (
    <nav className="space-y-0.5">
      <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-3 py-2 mb-1">
        Меню
      </p>
      {navItems.map((item) => {
